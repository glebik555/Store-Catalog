...
<body>
    ...
    <%
        ...
        out.println("<input value=\"Stock filter\" type=\"button\" onclick=\"location.href='indexStock.jsp'\" />");
    ...
    <div class="books">
        ...
        while(tmpHM.size()!=0){
            ...
            if(entry1.getValue()[0]>maxCost){
                maxCost = entry1.getValue()[0];
